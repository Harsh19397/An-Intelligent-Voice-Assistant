...
import numpy as np
from Deep_Speaker import audio, batcher, constant, conv_models, test_speaker
from audio import read_mfcc
from batcher import sample_from_mfcc
from constant import SAMPLE_RATE, NUM_FRAMES
from conv_models import DeepSpeakerModel
from test_speaker import batch_cosine_similarity
...
def get_speaker_identity(User_name, filename):
    ...
    if batch_cosine_similarity(predict_001, predict_002) > 0.75:
        return True
    else:
        return False